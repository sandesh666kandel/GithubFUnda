...
![TODO: Update the path with the name of your diagram](image/Unit13-GithubFundamental.png)
...
![TODO: Update the path with the name of your screenshot of docker ps output](image/docker_ps.JPG)
